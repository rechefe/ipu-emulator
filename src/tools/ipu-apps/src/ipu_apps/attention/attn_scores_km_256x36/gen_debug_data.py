"""FP32 debug-input generation for attn_scores_km_256x36.
...
``test/test_attn_scores_km_256x36_wide.py`` so that ``python -m ipu_apps.attention.attn_scores_km_256x36`` exercises the
...
from ipu_apps.attention.attn_scores_km_256x36 import N_TOK, D, N_HEADS
