...
``test/test_attn_v_16x60_wide.py`` so that ``python -m ipu_apps.attention.attn_v_16x60``
...
from ipu_apps.attention.attn_v_16x60 import N_TOK, D, N_HEAD, N_CHAN, LANES, PV_STRIDE_ROWS
