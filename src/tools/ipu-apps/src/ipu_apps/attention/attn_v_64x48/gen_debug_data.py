...
``python -m ipu_apps.attention.attn_v_64x48`` exercises the kernel the way its test does.
...
from ipu_apps.attention.attn_v_64x48 import N_TOK, D, N_BLOCK, N_CHAN, LANES
