...
# (n_tok=64, d=48). This app has no k_base_row-style hardware invariant to
# fold or exclude -- its constructor takes no extra kwargs.
...
SPEC = KernelSpec(
    ...
    op="qk_scores",
    variant="64x48",
    app_class=QkScores64x48App,
    asm="qk_scores_64x48.asm",
    requires=("n_tok", "d"),
