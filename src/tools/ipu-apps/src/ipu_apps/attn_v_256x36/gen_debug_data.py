...
``test/test_attn_v_256x36_wide.py`` so that ``python -m ipu_apps.attn_v_256x36`` exercises the
...
from ipu_apps.attn_v_256x36 import N_TOK, D, N_HEAD, N_CHAN, LANES, PV_STRIDE_ROWS
