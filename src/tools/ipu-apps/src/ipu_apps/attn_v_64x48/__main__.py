...
``test/test_attn_v_64x48_wide.py`` is the reference for correctness.

Usage::

    ATTN_V_64X48_INST_BIN=/tmp/attn_v_64x48.bin \
    uv run python -m ipu_apps.attn_v_64x48
"""
...
from ipu_apps.attn_v_64x48.gen_debug_data import generate
