...
``python -m ipu_apps.attn_v_bcast_60`` exercises the kernel the way its test
does.
...
from ipu_apps.attn_v_bcast_60 import N_TOK, D, N_HEAD, N_CHAN, LANES, PV_STRIDE_ROWS
