"""Debug runner for the 2-channel convolution app.

Usage::

    bazel run //src/tools/ipu-apps:conv2ch -- --dtype INT8
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run 2-channel conv with debug CLI")
    ...
    inst_path = Path(os.environ["CONV2CH_INST_BIN"])
    data_dir = Path(os.environ["CONV2CH_DATA_DIR"])
