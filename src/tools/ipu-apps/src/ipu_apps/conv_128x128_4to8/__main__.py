"""Debug runner for the standard 4->8 channel convolution app.

Usage::

    bazel run //src/tools/ipu-apps:conv_128x128_4to8 -- --dtype INT8
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run 4->8ch std conv with debug CLI")
    ...
    inst_path = Path(os.environ["CONV4TO8_INST_BIN"])
    data_dir = Path(os.environ["CONV4TO8_DATA_DIR"])
