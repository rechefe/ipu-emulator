"""Debug runner for the standard 8->16 channel convolution app.

Usage::

    bazel run //src/tools/ipu-apps:conv_128x128_8to16 -- --dtype INT8
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run 8->16ch std conv with debug CLI")
    ...
    inst_path = Path(os.environ["CONV8TO16_INST_BIN"])
    data_dir = Path(os.environ["CONV8TO16_DATA_DIR"])
