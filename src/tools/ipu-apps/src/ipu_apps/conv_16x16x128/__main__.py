"""Debug runner for the 16x16 128->128 channel convolution app.

Usage::

    bazel run //src/tools/ipu-apps:conv_16x16x128 -- --dtype INT8
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run 16x16 128->128 conv with debug CLI")
    ...
    inst_path = Path(os.environ["CONV16X16X128_INST_BIN"])
    data_dir = Path(os.environ["CONV16X16X128_DATA_DIR"])
