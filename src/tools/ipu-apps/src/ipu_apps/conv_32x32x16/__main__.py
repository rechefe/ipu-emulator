"""Debug runner for the 32x32 16->16 channel convolution app.

Usage::

    bazel run //src/tools/ipu-apps:conv_32x32x16 -- --dtype INT8
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run 32x32 16->16 conv with debug CLI")
    ...
    inst_path = Path(os.environ["CONV32X32X16_INST_BIN"])
    data_dir = Path(os.environ["CONV32X32X16_DATA_DIR"])
