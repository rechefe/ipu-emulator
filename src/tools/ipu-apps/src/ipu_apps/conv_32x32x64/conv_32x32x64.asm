# Standard 3x3 convolution: 64 input -> 64 output channels, 32x32.
#
...
#   cr0 = input  base  (8 groups x 64 ch x 128 bytes = 65536 bytes)
#   cr1 = kernel base  (64 filters x 8 blocks x 128 bytes = 65536 bytes)
#   cr2 = output base  (8 groups x 64 out_ch x 512 bytes = 262144 bytes)
...
#   lr7  = row-group base offset (g * 8192)
...
#     Filter loop (64 filters): reset_acc, process 8 channel groups, store.
...
ch_loop:
    ...
    # Middle loop limit: 7 * 8192 = 57344 = lr6 - lr15
    sub                 lr13 lr6 lr15;;
