"""Debug runner for the 32x32 96->96 channel convolution app.

Usage::

    bazel run //src/tools/ipu-apps:conv_32x32x96 -- --dtype INT8
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run 32x32 96->96 conv with debug CLI")
    ...
    inst_path = Path(os.environ["CONV32X32X96_INST_BIN"])
    data_dir = Path(os.environ["CONV32X32X96_DATA_DIR"])
