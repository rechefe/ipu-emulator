"""Standard 3x3 convolution harness (160 input -> 160 output channels, 8x8).
...
MASK_BASE_ADDR = 0x66800
OUTPUT_BASE_ADDR = 0x66A00

# Input: 80 packed chunks x 128 bytes = 10240 bytes
NUM_CHUNKS = IN_CHANNELS // 2  # 80

# Kernel: 20 blocks per filter, 128 bytes each
BLOCKS_PER_FILTER = 20
CHANNELS_PER_BLOCK = 8
TAPS_PER_CHANNEL = 9
FILTER_BLOCK_BYTES = 128
FILTER_PADDED_BYTES = BLOCKS_PER_FILTER * FILTER_BLOCK_BYTES  # 2560
KERNEL_TOTAL_BYTES = OUT_CHANNELS * FILTER_PADDED_BYTES  # 409600
...
class Conv8x8_160to160App(IpuApp):
    """Standard 3x3 convolution application harness (160->160 channels, 8x8).
    ...
    Args:
        ...
        kernel_path: Path to kernel binary (409600 bytes: 160 filters x 2560 bytes).
    ...
    def setup(self, state: "IpuState") -> None:
        ...
        # Load kernel (160 filters x 20 blocks x 128 bytes = 409600 bytes)
