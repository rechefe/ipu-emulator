"""Debug runner for the standard 160->160 channel convolution app (8x8)."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run 8x8 160->160ch std conv with debug CLI")
    ...
    inst_path = Path(os.environ["CONV8X8_160TO160_INST_BIN"])
    data_dir = Path(os.environ["CONV8X8_160TO160_DATA_DIR"])
