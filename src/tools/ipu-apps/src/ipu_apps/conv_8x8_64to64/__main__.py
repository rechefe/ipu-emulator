"""Debug runner for the standard 64->64 channel convolution app (8x8)."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run 8x8 64->64ch std conv with debug CLI")
    ...
    inst_path = Path(os.environ["CONV8X8_64TO64_INST_BIN"])
    data_dir = Path(os.environ["CONV8X8_64TO64_DATA_DIR"])
