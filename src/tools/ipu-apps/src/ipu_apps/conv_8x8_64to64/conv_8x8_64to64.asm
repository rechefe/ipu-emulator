# Standard 3x3 convolution: 64 input channels -> 64 output channels, 8x8.
#
...
#
# 64 input channels = 32 packed chunks.
...
#   ...
#   Block 7: channels 56-63 (72 bytes + 56 padding)
#
...
#   cr2 = output base  (32 pairs x 512 bytes = 16384 bytes; all lanes valid)
...
#   Each filter has 8 kernel blocks (8 channels each).
...
#   lr14 = kernel pair offset (0, 2048, 4096, ..., 63488)
#   lr15 = 16384 (output loop end = 32 pairs x 512)
...
# ===========================================================================
# Filter pair loop (32 pairs of 2 output filters)
# ===========================================================================
...
# 8 kernel blocks, 4 chunks each, with reload loop
# ###########################################################################
...
# lr7 = lr14 + 1024 (naturally from f0's 8 block increments)
# ###########################################################################
