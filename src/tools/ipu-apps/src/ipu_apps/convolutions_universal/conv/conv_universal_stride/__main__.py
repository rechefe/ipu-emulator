"""CLI entry point for the universal standard convolution app (stride 2)."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run universal standard 3x3 stride-2 convolution (cols=128) on the IPU emulator.",
    )
    ...
    parser.add_argument("--rows", type=int, required=True, help="Spatial height (must be even)")
    parser.add_argument("--cols", type=int, default=128, help="Spatial width (must be 128)")
