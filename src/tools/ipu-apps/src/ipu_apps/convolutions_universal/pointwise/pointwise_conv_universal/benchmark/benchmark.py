...
Usage::
    ...
    PYTHONPATH=... python -m ipu_apps.convolutions_universal.pointwise.pointwise_conv_universal.benchmark.benchmark
"""
...
from ipu_apps.convolutions_universal.pointwise.pointwise_conv_universal.gen_test_data import (
