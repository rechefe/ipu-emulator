"""Profile memory access patterns for pointwise_8x8 (1x1, 8x8 spatial).
...
Run from the repo root:
    PYTHONPATH=src/tools/ipu-emu-py/src:src/tools/ipu-common/src:src/tools/ipu-apps/src:src/tools/ipu-as-py/src \
        python -m ipu_apps.convolutions_universal.profiling.profile_pointwise_8x8
"""
...
def main() -> None:
    ...
    for ic, oc in CONFIGS:
        ...
        raw_kernel = rng.randint(0, 256, oc * ic, dtype=np.uint8).tobytes()
