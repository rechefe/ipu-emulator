"""Debug runner for the 64-channel depthwise convolution app.

Usage::

    bazel run //src/tools/ipu-apps:depthwise_conv_128x128x64 -- --dtype INT8
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run 64-ch depthwise conv with debug CLI")
    ...
    inst_path = Path(os.environ["DCONV64_INST_BIN"])
    data_dir = Path(os.environ["DCONV64_DATA_DIR"])
