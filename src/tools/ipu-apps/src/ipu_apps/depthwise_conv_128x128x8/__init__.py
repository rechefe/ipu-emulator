"""Multi-channel depthwise convolution harness (8 channels, 128x128, 3x3 kernel).
...
Usage::
    ...
    app = DepthwiseConv128x128x8App(
        inst_path="depthwise_conv_128x128x8.bin",
...
class DepthwiseConv128x128x8App(IpuApp):
    """Multi-channel depthwise convolution application harness.
