"""Debug runner for the 8-channel depthwise convolution app.

Usage::

    bazel run //src/tools/ipu-apps:depthwise_conv_128x128x8 -- --dtype INT8
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run 8-ch depthwise conv with debug CLI")
    ...
    inst_path = Path(os.environ["DCONV8_INST_BIN"])
    data_dir = Path(os.environ["DCONV8_DATA_DIR"])
