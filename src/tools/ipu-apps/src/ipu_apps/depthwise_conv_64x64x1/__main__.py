"""Debug runner for the 64x64x1 depthwise convolution app.

Usage::

    bazel run //src/tools/ipu-apps:depthwise_conv_64x64x1 -- --dtype INT8
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run 64x64x1 depthwise conv with debug CLI")
