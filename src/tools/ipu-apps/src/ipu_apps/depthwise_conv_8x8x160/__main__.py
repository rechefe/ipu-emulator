"""Debug runner for the depthwise 160-channel convolution app (8x8)."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run 8x8 160ch depthwise conv with debug CLI")
    ...
    inst_path = Path(os.environ["DEPTHWISE_CONV_8X8X160_INST_BIN"])
    data_dir = Path(os.environ["DEPTHWISE_CONV_8X8X160_DATA_DIR"])
