...
# Related: L4 variant of attn_v_256x36 (L3); attn_v_16x60 is the L5 variant;
#          consumes qk_scores_64x48's query-major output; attn_v_bcast_48
#          is the key-major (no-AGG) sibling for the same layer
# Tests:   test_attn_v_64x48 (src/tools/ipu-apps/BUILD.bazel)
#
...
#
# This is the L4 variant of attn_v_256x36; the compute model is carried over
# unchanged:
