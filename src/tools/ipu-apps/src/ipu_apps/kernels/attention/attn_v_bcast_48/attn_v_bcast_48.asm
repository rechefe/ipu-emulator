...
# Related: L4 variant of attn_v_bcast_36 (L3); attn_v_bcast_60 is the L5 variant;
#          consumes attn_scores_km_64x48's key-major output; attn_v_64x48
#          is the query-major (AGG) sibling for the same layer
# Tests:   test_attn_v_bcast_48 (src/tools/ipu-apps/BUILD.bazel)
#
...
#
# This is the L4 variant of attn_v_bcast_36. LANES = QUERIES and the standard
