...
This is the L5 variant of ``qk_scores_256x36``; the mapping is unchanged, only the
loop counts differ:
...
# invariant, and a caller that needs a non-default layout (the family's
# shared-state seam test) constructs the app directly.
