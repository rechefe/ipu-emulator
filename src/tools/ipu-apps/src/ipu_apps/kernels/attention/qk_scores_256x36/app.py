...
Usage::
    ...
    from ipu_apps.kernels.attention.qk_scores_256x36.app import QkScores256x36App
"""
...
# kernel's exact-match domain (n_tok=256, d=36). No k_base_row-style invariant
# here -- K_BASE_ROW is 0 by construction but the constructor takes no
# caller-supplied base-row kwargs to guard against.
