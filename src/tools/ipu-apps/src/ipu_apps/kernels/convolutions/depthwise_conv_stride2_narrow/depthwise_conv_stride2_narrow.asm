{#- The harness renders elements_in_row (= cols) per run; the default only
    lets the file assemble standalone (`assemble_<kernel>`). -#}
{%- set elements_in_row = elements_in_row | default(32) -%}
