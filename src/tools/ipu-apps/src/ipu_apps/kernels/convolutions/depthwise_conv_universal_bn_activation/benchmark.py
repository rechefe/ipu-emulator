"""Benchmark configs for depthwise_conv_universal_bn_activation
(``bazel run :benchmark_depthwise_conv_universal_bn_activation``)."""

CONFIGS = [
    dict(height=16, width=16, channels=8),    # partial single block
    dict(height=16, width=16, channels=25),   # exactly 1 full FPB=25 block
    dict(height=16, width=16, channels=26),   # 1 full + 1-channel partial
    ...
    dict(height=32, width=32, channels=50),   # exactly 2 full blocks
