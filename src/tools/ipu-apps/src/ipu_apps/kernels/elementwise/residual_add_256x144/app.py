...
Usage::
    ...
    from ipu_apps.kernels.elementwise.residual_add_256x144.app import ResidualAdd256x144App
"""
...
from ipu_apps.kernels.elementwise.app import residual_add_spec
...
SPEC = residual_add_spec(ResidualAdd256x144App, tokens=N_TOK, channels=N_CH)
