...
Usage::
    ...
    from ipu_apps.kernels.matmul.matmul_144x144_x128.app import MatMul144x144x128App
"""
...
SPEC = matmul_spec(MatMul144x144x128App, m=M, k=K, n=N, role="144x144 transformer matmul")
