...
#          all share this j_loop/k-loop template. Consumed by
#          proj_outproj_144_p4, which wraps the same arithmetic across all 4
#          pixel streams in one invocation.
# Tests:   //src/tools/ipu-apps:test_matmul_144x144_x128
#
...
k_loop2_tg0:
    ...
    # STR_POST_AAQ_REG drains it, CO-ISSUED in ONE VLIW word. AaQ and STR are
    # consecutive pipeline stages within a word and the in-word slot order is
    # CTRL -> MULT -> ACC -> AaQ -> STR (docs/content/specs/stage-aaq-str.md
