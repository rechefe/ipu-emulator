...
Usage::
    ...
    from ipu_apps.kernels.matmul.matmul_144x288_x128.app import MatMul144x288x128App
"""
...
SPEC = matmul_spec(MatMul144x288x128App, m=M, k=K, n=N, role="144x288 transformer matmul")
