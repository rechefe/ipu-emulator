"""Transformer matmul 288×144 harness (FFN linear 1, fused silu).

Computes C[j, t] = sum_k W[j, k] * D[k, t]  for all j in [0, 288), t in [0, 256).

Usage::

    from ipu_apps.kernels.matmul.matmul_288x144_x128.app import MatMul288x144x128App
"""
...
SPEC = matmul_spec(MatMul288x144x128App, m=M, k=K, n=N, role="288x144 transformer matmul", activation="silu")
