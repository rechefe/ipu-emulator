...
#          each 144 wide). Body identical to matmul_144x144_x128 (3x the
#          outputs -- only N_OUT and OUTPUT_BASE differ). Sibling family: matmul_288x144_x128
#          (FFN1), matmul_144x288_x128 (FFN2). Consumed by proj_qkv_144_p4
#          (all 4 streams, one invocation, same identity activation).
# Tests:   //src/tools/ipu-apps:test_matmul_432x144_x128
#
