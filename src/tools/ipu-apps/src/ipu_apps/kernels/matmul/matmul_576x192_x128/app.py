...
Usage::
    ...
    from ipu_apps.kernels.matmul.matmul_576x192_x128.app import MatMul576x192x128App
...
SPEC = matmul_spec(MatMul576x192x128App, m=M, k=K, n=N, role="576x192 transformer matmul")
