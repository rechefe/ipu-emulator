...
Usage::
    ...
    from ipu_apps.kernels.normalize.layernorm_256x144.app import LayerNorm256x144App
"""
...
SPEC = layernorm_spec(LayerNorm256x144App, channels=N_CH, tokens=TOTAL_TOKENS)
