...
# Scope:   single-stream
# Layout:  unpacked
# Shape:   64tok (1 tg) x 192chan
# Related: L4 variant of layernorm_256x144 (L3); layernorm_16x240 is the L5 variant;
#          feeds residual_add_64x192
# Tests:   test_layernorm_64x192 (src/tools/ipu-apps/BUILD.bazel)
#
