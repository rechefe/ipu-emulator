...
# Tests:   test_proj_outproj_144_p4 (src/tools/ipu-apps/BUILD.bazel)
#
...
# (proj_qkv_192_p4 et al.) -- the single-stream ancestor (matmul_144x144_x128)
...
# (matmul_144x144_x128) hand-duplicates tg=0/tg=1 blocks rather than looping,
