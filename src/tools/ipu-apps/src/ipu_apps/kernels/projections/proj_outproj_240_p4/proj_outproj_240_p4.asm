# Multi-stream transformer projection matmul (Layer 5 OutProj, P=4 pixel-streams).
#
# Layer:   L5
# Scope:   all-stream/P4
# Layout:  unpacked
# Shape:   240ch, P4 (4-stream), K=240->N_OUT=240
# Related: proj_qkv_240_p4 / proj_ffn1_240_p4 / proj_ffn2_240_p4 are the
#          other L5 P4 projections; shape suffix 144/192/240 = L3/L4/L5
#          (see docs/content/kernels/mobilevit.md)
# Tests:   test_proj_outproj_240_p4 (src/tools/ipu-apps/BUILD.bazel)
#
#   C[p, j, t] = sum_k W[j, k] * D[p, k, t]
#     p in [0,4), j in [0,N_OUT=240), k in [0,K=240), t in [0,N_TOK=16)
#
