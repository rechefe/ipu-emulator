...
# Scope:   all-stream/P4
# Layout:  unpacked
# Shape:   144ch, P4 (4-stream), K=144->N_OUT=432, N_TG=2
# Related: proj_outproj_144_p4 / proj_ffn1_144_p4 / proj_ffn2_144_p4 are
#          the other L3 P4 projections; shape suffix 144/192/240 = L3/L4/L5
#          (see docs/content/kernels/mobilevit.md)
# Tests:   test_proj_qkv_144_p4 (src/tools/ipu-apps/BUILD.bazel)
#
