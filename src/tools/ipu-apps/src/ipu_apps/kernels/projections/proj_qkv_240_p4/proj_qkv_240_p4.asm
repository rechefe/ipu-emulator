...
# Related: proj_outproj_240_p4 / proj_ffn1_240_p4 / proj_ffn2_240_p4 are
#          the other L5 P4 projections; shape suffix 144/192/240 = L3/L4/L5
#          (see docs/content/kernels/mobilevit.md)
# Tests:   test_proj_qkv_240_p4 (src/tools/ipu-apps/BUILD.bazel)
#
#   C[p, j, t] = sum_k W[j, k] * D[p, k, t]
#     p in [0,4), j in [0,N_OUT=720), k in [0,K=240), t in [0,N_TOK=16)
#
