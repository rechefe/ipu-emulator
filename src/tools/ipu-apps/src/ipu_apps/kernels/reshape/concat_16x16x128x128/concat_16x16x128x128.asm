# Concat 16x16x128x128: channel-axis concat of two same-spatial-shape tensors (L4)
#
# Layer:   L4
# Scope:   single-stream (two independent copy passes into one output buffer)
# Layout:  unpacked
# Shape:   two 128-channel inputs, 16x16 spatial -> one 256-channel output
...
#   packing the producer chose to put there (the 16x16=256 spatial elements of a
...
# it; verified empirically against this exact kernel before trusting the
# pipelining below.
#
