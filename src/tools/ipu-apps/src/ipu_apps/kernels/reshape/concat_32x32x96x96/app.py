...
the end of its L3 transformer block (both branches have 96
...
Usage::
    ...
    from ipu_apps.kernels.reshape.concat_32x32x96x96.app import Concat32x32x96x96App
"""
...
class Concat32x32x96x96App(IpuApp):
    ...
    Args:
        ...
        input_a_path: Path to input A (96 rows of 128 FP32 elements).
        input_b_path: Path to input B (96 rows of 128 FP32 elements).
...
SPEC = concat_spec(Concat32x32x96x96App, h=H, w=W, c_a=C_A, c_b=C_B)
