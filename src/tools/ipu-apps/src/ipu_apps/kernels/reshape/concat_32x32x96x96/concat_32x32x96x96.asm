# Concat 32x32x96x96: channel-axis concat of two same-spatial-shape tensors (L3)
#
# Layer:   L3
# Scope:   single-stream (two independent copy passes into one output buffer)
# Layout:  unpacked
# Shape:   two 96-channel inputs, 32x32 spatial -> one 192-channel output
...
#   packing the producer chose to put there (the 32x32=1024 spatial elements of a
