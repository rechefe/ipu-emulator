...
the end of its L5 transformer block (verified: both branches have 160
...
class Concat8x8x160x160App(IpuApp):
    ...
    Args:
        ...
        input_a_path: Path to input A (160 rows x 512 bytes).
        input_b_path: Path to input B (160 rows x 512 bytes).
