...
# Tests:   test_fold_16x16x192 (src/tools/ipu-apps/BUILD.bazel)
#
...
#      empirically too: the poisoned round trip in reshape/test.py fills
#      r_acc with a non-zero sentinel before fold runs and asserts the
