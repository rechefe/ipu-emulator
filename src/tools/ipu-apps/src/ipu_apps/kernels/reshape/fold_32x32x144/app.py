...
Exact inverse of :mod:`ipu_apps.kernels.reshape.unfold_32x32x144`: takes the same 4
...
Usage::
    ...
    from ipu_apps.kernels.reshape.fold_32x32x144.app import Fold32x32x144App
"""
