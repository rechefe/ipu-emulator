...
#          rounding from the x1.0 pass-through multiply, which is exact) by
#          the round-trip tests in reshape/test.py.
# Tests:   test_fold_8x8x240 (src/tools/ipu-apps/BUILD.bazel)
#
...
# and verified up front: L3 (fold_32x32x144) and L4 (fold_16x16x192) both produce
...
# (the lesson from fold_16x16x192: never trust
...
# unfold_8x8x240's own reference computation already assumes.
#
...
#   channel purely for auditability (correctness-first; a
