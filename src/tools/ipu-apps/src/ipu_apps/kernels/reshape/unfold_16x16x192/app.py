...
NOT a port of :mod:`ipu_apps.kernels.reshape.unfold_32x32x144` — the geometry differs. L3 has
...
half of each row. This is the deliberate per-stream layout; a
...
class Unfold16x16x192App(IpuApp):
    ...
    def setup(self, state: "IpuState") -> None:
        ...
        # constant — writing anything else raises EmulatorError (issue #230) — so stripe 1 goes to CR13.
