...
``test/test_layernorm_128x16.py`` so that ``python -m ipu_apps.layernorm.layernorm_128x16`` exercises the
...
from ipu_apps.layernorm.layernorm_128x16 import N_CH, N_TPG, ROW_BYTES
