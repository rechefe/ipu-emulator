...
``test/test_layernorm_256x144.py`` so that ``python -m ipu_apps.layernorm_256x144`` exercises the
...
from ipu_apps.layernorm_256x144 import N_CH, N_TG, N_TPG, ROW_BYTES
