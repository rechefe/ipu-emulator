"""FP32 debug-input generation for matmul_128x128.
...
``test/test_matmul_128x128_wide.py`` so that ``python -m ipu_apps.matmul_128x128`` exercises the
...
from ipu_apps.matmul_128x128 import M, K, N
