"""Debug runner for the matmul_128x64x128 app.

Usage::

    bazel run //src/tools/ipu-apps:matmul_128x64x128 -- --dtype INT8
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run matmul_128x64x128 with debug CLI")
    ...
    inst_path = Path(os.environ["MATMUL_128X64X128_INST_BIN"])
    data_dir = Path(os.environ["MATMUL_128X64X128_DATA_DIR"])
