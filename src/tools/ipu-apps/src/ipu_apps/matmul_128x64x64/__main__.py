"""Debug runner for the matmul_128x64x64 app.

Usage::

    bazel run //src/tools/ipu-apps:matmul_128x64x64 -- --dtype INT8
"""
...
def main() -> None:
    ...
    inst_path = Path(os.environ["MATMUL_128X64X64_INST_BIN"])
    data_dir = Path(os.environ["MATMUL_128X64X64_DATA_DIR"])
