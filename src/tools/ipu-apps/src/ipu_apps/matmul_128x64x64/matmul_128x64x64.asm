...
# valid. Use incr lr7 256 (not 512) to pack outputs contiguously — identical to FC
# convention. The zero upper half of each write is overwritten by the next row.
#
...
#
# Differs from matmul_128x64x128.asm only in: incr lr7 256 (not 512).
