...
#
# CRs: cr0=DATA_BASE, cr1=WEIGHTS_BASE, cr2=WEIGHTS_BASE+128, cr3=OUTPUT_BASE
# LRs:
...
#   WEIGHTS: 144 rows × 256 B    =  36 864 B  (0x10000..0x18FFF)
#   OUTPUT:  144×2 rows × 512 B  = 147 456 B  (0x20000..0x43FFF)
