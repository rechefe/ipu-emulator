...
#
# D: channel-major [288 channels, 2 token-groups, 128 tokens]
...
# C: channel-major [144 out_ch, 2 tg, 128 tokens], FP32 accumulators
...
#
# Memory layout:
#   DATA:    288 channels × 256 B = 73 728 B  (0x00000..0x11FFF)
#   WEIGHTS: 144 rows × 384 B    =  55 296 B  (0x20000..0x2D7FF)
#   OUTPUT:  144×2 rows × 512 B  = 147 456 B  (0x40000..0x63FFF)
...
k_loop_tg0:                                  # K+1 iterations: 1 dummy startup + K real (k=0..287)
    ...
    str_acc_reg         lr7 cr4;;            # store 512 B accumulator → OUTPUT[j, tg=0]  (note: cr4)
