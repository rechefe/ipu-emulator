...
``test/test_matmul_192x192_x128_wide.py`` so that ``python -m ipu_apps.matmul_192x192_x128`` exercises the
...
from ipu_apps.matmul_192x192_x128 import K, N_OUT, N_TOK
