"""Generate test data for the matmul_192x384_x128 app.

Usage::

    uv run python src/ipu_apps/matmul_192x384_x128/gen_test_data.py
"""
...
def main() -> None:
    ...
    print("Generating matmul_192x384_x128 test data...")
