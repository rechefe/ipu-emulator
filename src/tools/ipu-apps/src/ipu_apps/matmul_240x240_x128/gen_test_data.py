"""Generate test data for the matmul_240x240_x128 app.

Usage::

    uv run python src/ipu_apps/matmul_240x240_x128/gen_test_data.py
"""
...
def main() -> None:
    ...
    print("Generating matmul_240x240_x128 test data...")
