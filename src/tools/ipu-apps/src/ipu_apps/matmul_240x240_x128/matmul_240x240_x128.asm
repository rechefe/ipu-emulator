...
# W: output-major [240 out_ch, 240 in_ch], NO transposition; 2 chunks of <=128 bytes
...
#   WEIGHTS: 240 rows x 256 B =   61440 B (0x10000..0x1EFFF)
#   OUTPUT:  240 rows x 64 B =   15360 B (0x20000..0x23BFF)
