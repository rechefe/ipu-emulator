...
Usage::
    ...
    MATMUL_288X144_X128_DATA_DIR=src/ipu_apps/matmul_288x144_x128/test_data_format \
...
_DATA_DIR = Path(os.environ["MATMUL_288X144_X128_DATA_DIR"])
...
app = MatMul288x144x128App(
    ...
    output_path="/tmp/matmul_288x144_x128_out.bin",
    dtype="INT8",
)
