...
k_loop2_tg0:
    ...
    ACTIVATE.QUANTIZE silu {{ DSTRUCT }}; STR_POST_AAQ_REG {{ out_ptr }} {{ OUT_BASE_TG0 }};;# store 512B → OUTPUT[j, tg=0]
...
k_loop2_tg1:
    ...
    ACTIVATE.QUANTIZE silu {{ DSTRUCT }}; STR_POST_AAQ_REG {{ out_ptr }} {{ OUT_BASE_TG1 }};;# store 512B → OUTPUT[j, tg=1]
