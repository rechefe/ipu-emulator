...
``test/test_matmul_720x240_x128_wide.py`` so that ``python -m ipu_apps.matmul_720x240_x128`` exercises the
...
from ipu_apps.matmul_720x240_x128 import K, N_OUT, N_TOK
