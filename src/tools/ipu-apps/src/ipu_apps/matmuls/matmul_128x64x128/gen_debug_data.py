"""FP32 debug-input generation for matmul_128x64x128.
...
``test/test_matmul_128x64x128_wide.py`` so that ``python -m ipu_apps.matmuls.matmul_128x64x128`` exercises the
...
from ipu_apps.matmuls.matmul_128x64x128 import M, K, N
