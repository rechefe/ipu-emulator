...
``test/test_matmul_128x64x64_wide.py`` so that ``python -m ipu_apps.matmuls.matmul_128x64x64`` exercises the
...
from ipu_apps.matmuls.matmul_128x64x64 import M, K, N
