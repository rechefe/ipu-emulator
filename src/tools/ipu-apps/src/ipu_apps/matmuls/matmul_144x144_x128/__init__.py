...
def _explain(**params):
    return f"(M, K, N) == {(M, K, N)} exactly: the fixed-shape 144x144 transformer matmul kernel."


SPEC = KernelSpec(
    name="matmul_144x144_x128",
    op=OP,
    variant="144x144_x128",
    app_class=MatMul144x144x128App,
    asm="matmul_144x144_x128.asm",
