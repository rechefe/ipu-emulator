...
def _explain(**params):
    return f"(M, K, N) == {(M, K, N)} exactly: the fixed-shape 144x288 transformer matmul kernel (FFN2)."


SPEC = KernelSpec(
    name="matmul_144x288_x128",
    op=OP,
    variant="144x288_x128",
    app_class=MatMul144x288x128App,
    asm="matmul_144x288_x128.asm",
