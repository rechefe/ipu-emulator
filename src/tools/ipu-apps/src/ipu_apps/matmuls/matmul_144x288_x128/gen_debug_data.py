"""FP32 debug-input generation for matmul_144x288_x128.
...
``test/test_matmul_144x288_x128_wide.py`` so that ``python -m ipu_apps.matmuls.matmul_144x288_x128`` exercises the
...
from ipu_apps.matmuls.matmul_144x288_x128 import K, N_OUT, N_TG, N_TOK
