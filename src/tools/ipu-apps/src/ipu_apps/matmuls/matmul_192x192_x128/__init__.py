...
def _explain(**params):
    return f"(M, K, N) == {(M, K, N)} exactly: the fixed-shape 192x192 transformer matmul kernel (Layer 4 OutProj)."


SPEC = KernelSpec(
    name="matmul_192x192_x128",
    op=OP,
    variant="192x192_x128",
    app_class=MatMul192x192x128App,
    asm="matmul_192x192_x128.asm",
