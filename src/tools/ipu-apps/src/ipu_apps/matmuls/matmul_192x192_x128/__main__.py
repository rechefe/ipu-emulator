...
``test/test_matmul_192x192_x128_wide.py`` is the reference for correctness.

Usage::

    MATMUL_192X192_X128_INST_BIN=/tmp/matmul_192x192_x128.bin \
    uv run python -m ipu_apps.matmuls.matmul_192x192_x128
"""
...
from ipu_apps.matmuls.matmul_192x192_x128 import MatMul192x192x128App
from ipu_apps.matmuls.matmul_192x192_x128.gen_debug_data import generate

_INST_BIN = Path(os.environ["MATMUL_192X192_X128_INST_BIN"])


def main() -> None:
    work = Path(tempfile.mkdtemp(prefix="matmul_192x192_x128_"))
