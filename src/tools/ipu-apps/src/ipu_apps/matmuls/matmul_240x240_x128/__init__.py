...
def _explain(**params):
    return f"(M, K, N) == {(M, K, N)} exactly: the fixed-shape 240x240 transformer matmul kernel (Layer 5 OutProj)."


SPEC = KernelSpec(
    name="matmul_240x240_x128",
    op=OP,
    variant="240x240_x128",
    app_class=MatMul240x240x128App,
    asm="matmul_240x240_x128.asm",
