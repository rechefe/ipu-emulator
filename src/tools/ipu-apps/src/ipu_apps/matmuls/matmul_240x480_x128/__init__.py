...
def _explain(**params):
    return f"(M, K, N) == {(M, K, N)} exactly: the fixed-shape 240x480 transformer matmul kernel (Layer 5 FFN2)."


SPEC = KernelSpec(
    name="matmul_240x480_x128",
    op=OP,
    variant="240x480_x128",
    app_class=MatMul240x480x128App,
    asm="matmul_240x480_x128.asm",
