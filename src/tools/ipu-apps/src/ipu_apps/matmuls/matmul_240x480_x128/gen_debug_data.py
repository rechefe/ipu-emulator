"""FP32 debug-input generation for matmul_240x480_x128.
...
``test/test_matmul_240x480_x128_wide.py`` so that ``python -m ipu_apps.matmuls.matmul_240x480_x128`` exercises the
...
from ipu_apps.matmuls.matmul_240x480_x128 import K, N_OUT, N_TOK
...
def generate(out_dir: Path) -> dict[str, Path]:
    ...
    D = rng.uniform(-1.0, 1.0, size=(K, N_TOK))
