...
def _explain(**params):
    return f"(M, K, N) == {(M, K, N)} exactly: the fixed-shape 288x144 transformer matmul kernel (FFN1)."


SPEC = KernelSpec(
    name="matmul_288x144_x128",
    op=OP,
    variant="288x144_x128",
    app_class=MatMul288x144x128App,
    asm="matmul_288x144_x128.asm",
