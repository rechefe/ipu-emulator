...
def _explain(**params):
    return f"(M, K, N) == {(M, K, N)} exactly: the fixed-shape 384x192 transformer matmul kernel (Layer 4 FFN1)."


SPEC = KernelSpec(
    name="matmul_384x192_x128",
    op=OP,
    variant="384x192_x128",
    app_class=MatMul384x192x128App,
    asm="matmul_384x192_x128.asm",
