...
def _explain(**params):
    return f"(M, K, N) == {(M, K, N)} exactly: the fixed-shape 480x240 transformer matmul kernel (Layer 5 FFN1)."


SPEC = KernelSpec(
    name="matmul_480x240_x128",
    op=OP,
    variant="480x240_x128",
    app_class=MatMul480x240x128App,
    asm="matmul_480x240_x128.asm",
