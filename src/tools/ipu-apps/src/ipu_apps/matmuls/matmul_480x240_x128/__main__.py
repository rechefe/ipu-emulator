...
``test/test_matmul_480x240_x128_wide.py`` is the reference for correctness.

Usage::

    MATMUL_480X240_X128_INST_BIN=/tmp/matmul_480x240_x128.bin \
    uv run python -m ipu_apps.matmuls.matmul_480x240_x128
"""
...
from ipu_apps.matmuls.matmul_480x240_x128 import MatMul480x240x128App
from ipu_apps.matmuls.matmul_480x240_x128.gen_debug_data import generate

_INST_BIN = Path(os.environ["MATMUL_480X240_X128_INST_BIN"])


def main() -> None:
    work = Path(tempfile.mkdtemp(prefix="matmul_480x240_x128_"))
