...
def _explain(**params):
    return f"(M, K, N) == {(M, K, N)} exactly: the fixed-shape 576x192 transformer matmul kernel (Layer 4 QKV)."


SPEC = KernelSpec(
    name="matmul_576x192_x128",
    op=OP,
    variant="576x192_x128",
    app_class=MatMul576x192x128App,
    asm="matmul_576x192_x128.asm",
