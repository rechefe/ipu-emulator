"""FP32 debug-input generation for matmul_64x64x64.
...
``test/test_matmul_64x64x64_wide.py`` so that ``python -m ipu_apps.matmuls.matmul_64x64x64`` exercises the
...
from ipu_apps.matmuls.matmul_64x64x64 import M, K, N
