...
def _explain(**params):
    return f"(M, K, N) == {(M, K, N)} exactly: the fixed-shape 720x240 transformer matmul kernel (Layer 5 QKV)."


SPEC = KernelSpec(
    name="matmul_720x240_x128",
    op=OP,
    variant="720x240_x128",
    app_class=MatMul720x240x128App,
    asm="matmul_720x240_x128.asm",
