...
Usage::
    ...
    uv run python -m ipu_apps.matmuls.matmul_720x240_x128
"""
...
from ipu_apps.matmuls.matmul_720x240_x128 import MatMul720x240x128App
from ipu_apps.matmuls.matmul_720x240_x128.gen_debug_data import generate
