...
tg0_store:
    ACTIVATE.QUANTIZE silu {{ DSTRUCT }}; STR_POST_AAQ_REG {{ out_ptr }} {{ ZERO }};;   # C[p,tg=0,j,:] = R_ACC
...
tg1_store:
    ACTIVATE.QUANTIZE silu {{ DSTRUCT }}; STR_POST_AAQ_REG {{ out_ptr_tg1 }} {{ ZERO }};;   # C[p,tg=1,j,:] = R_ACC
