# Multi-stream transformer projection matmul (Layer 5 FFN1, P=4 pixel-streams).
#
# Layer:   L5
# Scope:   all-stream/P4
# Layout:  unpacked
# Shape:   240ch, P4 (4-stream), K=240->N_OUT=480
# Status:  validated
# Related: proj_ffn2_240_p4 is the FFN pair closing this MLP block at L5;
#          proj_qkv_240_p4 / proj_outproj_240_p4 are the other L5 P4
#          projections; shape suffix 144/192/240 = L3/L4/L5 (see
#          kernel_docs/kernel_layer_map.md)
# Tests:   test_proj_ffn1_240_p4_wide (src/tools/ipu-apps/BUILD.bazel)
#
#   C[p, j, t] = sum_k W[j, k] * D[p, k, t]
#     p in [0,4), j in [0,N_OUT=480), k in [0,K=240), t in [0,N_TOK=16)
#
...
#   K=240 needs ceil(192/128)=2 chunks: full width 128, tail width 64.
...
#   .asm control-flow text handles K=240/240/384/480 without new labels.
...
store_out:
    ...
    STR_POST_AAQ_REG {{ out_ptr }} {{ ZERO }};;  # C[p,j,:] = silu(R_ACC) (FFN1 nonlinearity)
