...
Usage::
    ...
    PROJ_QKV_192_P4_INST_BIN=/tmp/proj_ffn2_192_p4.bin \
    uv run python -m ipu_apps.proj_ffn2_192_p4
"""
...
from ipu_apps.proj_ffn2_192_p4 import ProjFFN2192P4App, K, N_OUT, N_TOK, N_STREAM
