# Multi-stream transformer projection matmul (Layer 4 FFN2, P=4 pixel-streams).
#
# Layer:   L4
# Scope:   all-stream/P4
# Layout:  unpacked
# Shape:   192ch, P4 (4-stream), K=384->N_OUT=192
# Status:  validated
# Related: proj_ffn1_192_p4 is the FFN pair opening this MLP block at L4;
#          proj_qkv_192_p4 / proj_outproj_192_p4 are the other L4 P4
#          projections; shape suffix 144/192/240 = L3/L4/L5 (see
#          kernel_docs/kernel_layer_map.md)
# Tests:   test_proj_ffn2_192_p4_wide (src/tools/ipu-apps/BUILD.bazel)
#
#   C[p, j, t] = sum_k W[j, k] * D[p, k, t]
#     p in [0,4), j in [0,N_OUT=192), k in [0,K=384), t in [0,N_TOK=64)
#
...
#   K=384 needs ceil(192/128)=2 chunks: full width 128, tail width 64.
...
#   .asm control-flow text handles K=384/240/384/480 without new labels.
