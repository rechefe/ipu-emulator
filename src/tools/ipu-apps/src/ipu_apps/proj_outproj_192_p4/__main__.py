"""Debug runner for proj_outproj_192_p4.
...
results -- ``test/test_proj_outproj_192_p4_wide.py`` is the reference for
correctness.

Usage::

    PROJ_QKV_192_P4_INST_BIN=/tmp/proj_outproj_192_p4.bin \
    uv run python -m ipu_apps.proj_outproj_192_p4
"""
...
from ipu_apps.proj_outproj_192_p4 import ProjOutProj192P4App, K, N_OUT, N_TOK, N_STREAM
