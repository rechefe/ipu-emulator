...
Usage::
    ...
    PROJ_QKV_192_P4_INST_BIN=/tmp/proj_outproj_240_p4.bin \
    uv run python -m ipu_apps.proj_outproj_240_p4
"""
...
from ipu_apps.proj_outproj_240_p4 import ProjOutProj240P4App, K, N_OUT, N_TOK, N_STREAM

_INST_BIN = Path(os.environ["PROJ_QKV_192_P4_INST_BIN"])
_SEED = 0xC0FFEE
