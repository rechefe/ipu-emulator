...
Usage::
    ...
    from ipu_apps.projections.proj_ffn1_144_p4 import ProjFfn1144P4App
...
def _explain(**params):
    return (
        f"k == {K} and n_out == {N_OUT} exactly: the Layer 3 FFN1 multi-stream "
...
SPEC = KernelSpec(
    ...
    op="projection",
    variant="ffn1_144",
    app_class=ProjFfn1144P4App,
    asm="proj_ffn1_144_p4.asm",
    requires=("k", "n_out"),
