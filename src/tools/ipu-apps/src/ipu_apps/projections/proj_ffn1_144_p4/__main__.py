"""Debug runner for proj_ffn1_144_p4.
...
results -- ``test/test_proj_ffn1_144_p4_wide.py`` is the reference for
correctness.

Usage::

    PROJ_FFN1_144_P4_INST_BIN=/tmp/proj_ffn1_144_p4.bin \
    uv run python -m ipu_apps.projections.proj_ffn1_144_p4
"""
