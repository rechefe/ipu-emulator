# Multi-stream transformer projection matmul (Layer 3 FFN1, P=4 pixel-streams).
#
# Layer:   L3
# Scope:   all-stream/P4
# Layout:  unpacked
# Shape:   144ch, P4 (4-stream), K=144->N_OUT=288, N_TG=2
# Status:  validated
# Related: proj_ffn2_144_p4 is the FFN pair closing this MLP block at L3;
...
# Tests:   test_proj_ffn1_144_p4_wide (src/tools/ipu-apps/BUILD.bazel)
#
#   C[p, tg, j, t] = sum_k W[j, k] * D[p, k, tg, t]
#     p in [0,4), j in [0,N_OUT    = 288), k in [0,K        = 144), tg in [0,N_TG=2), t in [0,128)
#
...
# (proj_qkv_192_p4 et al.) -- the single-stream ancestor (matmul_144x288_x128)
...
# (matmul_144x288_x128) hand-duplicates tg=0/tg=1 blocks rather than looping,
