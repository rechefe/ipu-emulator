...
Usage::
    ...
    from ipu_apps.projections.proj_ffn1_192_p4 import ProjFFN1192P4App
...
def _explain(**params):
    return (
        f"k == {K} and n_out == {N_OUT} exactly: the Layer 4 FFN1 multi-stream "
...
SPEC = KernelSpec(
    ...
    op="projection",
    variant="ffn1_192",
    app_class=ProjFFN1192P4App,
    asm="proj_ffn1_192_p4.asm",
    requires=("k", "n_out"),
