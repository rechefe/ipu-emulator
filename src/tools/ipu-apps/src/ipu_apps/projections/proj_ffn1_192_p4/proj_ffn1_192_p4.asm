# Multi-stream transformer projection matmul (Layer 4 FFN1, P=4 pixel-streams).
#
# Layer:   L4
# Scope:   all-stream/P4
# Layout:  unpacked
# Shape:   192ch, P4 (4-stream), K=192->N_OUT=384
# Status:  validated
# Related: proj_ffn2_192_p4 is the FFN pair closing this MLP block at L4;
...
# Tests:   test_proj_ffn1_192_p4_wide (src/tools/ipu-apps/BUILD.bazel)
#
#   C[p, j, t] = sum_k W[j, k] * D[p, k, t]
#     p in [0,4), j in [0,N_OUT=384), k in [0,K=192), t in [0,N_TOK=64)
#
