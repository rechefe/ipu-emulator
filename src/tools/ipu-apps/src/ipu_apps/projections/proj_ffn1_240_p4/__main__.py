"""Debug runner for proj_ffn1_240_p4.
...
results -- ``test/test_proj_ffn1_240_p4_wide.py`` is the reference for
correctness.

Usage::

    PROJ_FFN1_240_P4_INST_BIN=/tmp/proj_ffn1_240_p4.bin \
    uv run python -m ipu_apps.projections.proj_ffn1_240_p4
"""
...
from ipu_apps.projections.proj_ffn1_240_p4 import ProjFFN1240P4App, K, N_OUT, N_TOK, N_STREAM

_SEED = 0xC0FFEE


def main() -> None:
    _INST_BIN = Path(os.environ["PROJ_FFN1_240_P4_INST_BIN"])

    work = Path(tempfile.mkdtemp(prefix="proj_ffn1_240_p4_"))
