"""Debug runner for proj_ffn2_144_p4.
...
results -- ``test/test_proj_ffn2_144_p4_wide.py`` is the reference for
correctness.

Usage::

    PROJ_FFN2_144_P4_INST_BIN=/tmp/proj_ffn2_144_p4.bin \
    uv run python -m ipu_apps.projections.proj_ffn2_144_p4
"""
...
from ipu_apps.projections.proj_ffn2_144_p4 import (
    ProjFfn2144P4App, K, N_OUT, N_TG, N_TOK, N_STREAM,
)
...
def main() -> None:
    work = Path(tempfile.mkdtemp(prefix="proj_ffn2_144_p4_"))
