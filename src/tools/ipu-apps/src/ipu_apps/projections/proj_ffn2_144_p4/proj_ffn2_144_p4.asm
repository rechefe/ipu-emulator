# Multi-stream transformer projection matmul (Layer 3 FFN2, P=4 pixel-streams).
#
# Layer:   L3
# Scope:   all-stream/P4
# Layout:  unpacked
# Shape:   144ch, P4 (4-stream), K=288->N_OUT=144, N_TG=2
# Status:  validated
# Related: proj_ffn1_144_p4 is the FFN pair opening this MLP block at L3;
#          proj_qkv_144_p4 / proj_outproj_144_p4 are the other L3 P4
#          projections; shape suffix 144/192/240 = L3/L4/L5 (see
#          kernel_docs/kernel_layer_map.md)
# Tests:   test_proj_ffn2_144_p4_wide (src/tools/ipu-apps/BUILD.bazel)
#
#   C[p, tg, j, t] = sum_k W[j, k] * D[p, k, tg, t]
#     p in [0,4), j in [0,N_OUT    = 144), k in [0,K        = 288), tg in [0,N_TG=2), t in [0,128)
#
...
# (proj_qkv_192_p4 et al.) -- the single-stream ancestor (matmul_288x144_x128)
...
# (matmul_288x144_x128) hand-duplicates tg=0/tg=1 blocks rather than looping,
...
# ancestor): K        = 288 needs ceil(144/128)=2 chunks: full width 128, tail width
