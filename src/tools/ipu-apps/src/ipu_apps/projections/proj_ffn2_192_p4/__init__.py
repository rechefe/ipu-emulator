"""Multi-stream transformer projection matmul harness (Layer 4 FFN2, P=4).
...
Usage::
    ...
    from ipu_apps.projections.proj_ffn2_192_p4 import ProjFFN2192P4App

    app = ProjFFN2192P4App(
        inst_path="proj_ffn2_192_p4.bin",
...
def _explain(**params):
    return (
        f"k == {K} and n_out == {N_OUT} exactly: the Layer 4 FFN2 multi-stream "
...
SPEC = KernelSpec(
    ...
    op="projection",
    variant="ffn2_192",
    app_class=ProjFFN2192P4App,
    asm="proj_ffn2_192_p4.asm",
    requires=("k", "n_out"),
