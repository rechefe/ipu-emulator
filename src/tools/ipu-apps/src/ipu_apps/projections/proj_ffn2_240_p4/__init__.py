...
Usage::
    ...
    from ipu_apps.projections.proj_ffn2_240_p4 import ProjFFN2240P4App
...
def _explain(**params):
    return (
        f"k == {K} and n_out == {N_OUT} exactly: the Layer 5 FFN2 multi-stream "
...
SPEC = KernelSpec(
    ...
    op="projection",
    variant="ffn2_240",
    app_class=ProjFFN2240P4App,
    asm="proj_ffn2_240_p4.asm",
    requires=("k", "n_out"),
