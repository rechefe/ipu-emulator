"""Debug runner for proj_ffn2_240_p4.
...
results -- ``test/test_proj_ffn2_240_p4_wide.py`` is the reference for
correctness.

Usage::

    PROJ_FFN2_240_P4_INST_BIN=/tmp/proj_ffn2_240_p4.bin \
    uv run python -m ipu_apps.projections.proj_ffn2_240_p4
"""
...
from ipu_apps.projections.proj_ffn2_240_p4 import ProjFFN2240P4App, K, N_OUT, N_TOK, N_STREAM

_INST_BIN = Path(os.environ["PROJ_FFN2_240_P4_INST_BIN"])
_SEED = 0xC0FFEE


def main() -> None:
    work = Path(tempfile.mkdtemp(prefix="proj_ffn2_240_p4_"))
