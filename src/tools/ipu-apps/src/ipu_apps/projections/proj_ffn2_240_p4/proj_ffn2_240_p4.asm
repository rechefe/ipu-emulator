# Multi-stream transformer projection matmul (Layer 5 FFN2, P=4 pixel-streams).
#
# Layer:   L5
# Scope:   all-stream/P4
# Layout:  unpacked
# Shape:   240ch, P4 (4-stream), K=480->N_OUT=240
# Status:  validated
# Related: proj_ffn1_240_p4 is the FFN pair opening this MLP block at L5;
...
# Tests:   test_proj_ffn2_240_p4_wide (src/tools/ipu-apps/BUILD.bazel)
#
#   C[p, j, t] = sum_k W[j, k] * D[p, k, t]
#     p in [0,4), j in [0,N_OUT=240), k in [0,K=480), t in [0,N_TOK=16)
#
...
#   K=480 needs ceil(192/128)=2 chunks: full width 128, tail width 64.
...
#   .asm control-flow text handles K=480/240/384/480 without new labels.
