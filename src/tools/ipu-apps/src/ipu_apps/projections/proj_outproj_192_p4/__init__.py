...
Usage::
    ...
    from ipu_apps.projections.proj_outproj_192_p4 import ProjOutProj192P4App
...
def _explain(**params):
    return (
        f"k == {K} and n_out == {N_OUT} exactly: the Layer 4 OutProj multi-stream "
...
SPEC = KernelSpec(
    ...
    op="projection",
    variant="outproj_192",
    app_class=ProjOutProj192P4App,
    asm="proj_outproj_192_p4.asm",
    requires=("k", "n_out"),
