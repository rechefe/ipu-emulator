...
Usage::
    ...
    from ipu_apps.projections.proj_outproj_240_p4 import ProjOutProj240P4App
...
class ProjOutProj240P4App(IpuApp):
...
def _explain(**params):
    return (
        f"k == {K} and n_out == {N_OUT} exactly: the Layer 5 OutProj multi-stream "
...
SPEC = KernelSpec(
    ...
    op="projection",
    variant="outproj_240",
    app_class=ProjOutProj240P4App,
    asm="proj_outproj_240_p4.asm",
    requires=("k", "n_out"),
