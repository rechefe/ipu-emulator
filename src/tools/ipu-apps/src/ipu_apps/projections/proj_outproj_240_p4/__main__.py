"""Debug runner for proj_outproj_240_p4.
...
results -- ``test/test_proj_outproj_240_p4_wide.py`` is the reference for
correctness.

Usage::

    PROJ_OUTPROJ_240_P4_INST_BIN=/tmp/proj_outproj_240_p4.bin \
    uv run python -m ipu_apps.projections.proj_outproj_240_p4
"""
...
from ipu_apps.projections.proj_outproj_240_p4 import ProjOutProj240P4App, K, N_OUT, N_TOK, N_STREAM

_SEED = 0xC0FFEE


def main() -> None:
    _INST_BIN = Path(os.environ["PROJ_OUTPROJ_240_P4_INST_BIN"])

    work = Path(tempfile.mkdtemp(prefix="proj_outproj_240_p4_"))
