...
Usage::
    ...
    from ipu_apps.projections.proj_qkv_192_p4 import ProjQkv192P4App
...
def _explain(**params):
    return (
        f"k == {K} and n_out == {N_OUT} exactly: the Layer 4 QKV multi-stream "
...
SPEC = KernelSpec(
    ...
    op="projection",
    variant="qkv_192",
    app_class=ProjQkv192P4App,
    asm="proj_qkv_192_p4.asm",
    requires=("k", "n_out"),
