"""Debug runner for proj_qkv_192_p4.
...
results -- ``test/test_proj_qkv_192_p4_wide.py`` is the reference for
correctness.

Usage::

    PROJ_QKV_192_P4_INST_BIN=/tmp/proj_qkv_192_p4.bin \
    uv run python -m ipu_apps.projections.proj_qkv_192_p4
"""
...
from ipu_apps.projections.proj_qkv_192_p4 import ProjQkv192P4App, K, N_OUT, N_TOK, N_STREAM
...
def main() -> None:
    work = Path(tempfile.mkdtemp(prefix="proj_qkv_192_p4_"))
