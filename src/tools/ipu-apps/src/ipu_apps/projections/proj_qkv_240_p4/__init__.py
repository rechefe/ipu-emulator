...
Usage::
    ...
    from ipu_apps.projections.proj_qkv_240_p4 import ProjQKV240P4App
...
def _explain(**params):
    return (
        f"k == {K} and n_out == {N_OUT} exactly: the Layer 5 QKV multi-stream "
...
SPEC = KernelSpec(
    ...
    op="projection",
    variant="qkv_240",
    app_class=ProjQKV240P4App,
    asm="proj_qkv_240_p4.asm",
    requires=("k", "n_out"),
