"""Debug runner for qk_scores_64x48.
...
``test/test_qk_scores_64x48_wide.py`` is the reference for correctness.

Usage::

    QK_SCORES_64X48_INST_BIN=/tmp/qk_scores_64x48.bin \
    uv run python -m ipu_apps.qk_scores_64x48
"""
...
from ipu_apps.qk_scores_64x48.gen_debug_data import generate
