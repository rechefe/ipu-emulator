...
Usage::
    ...
    from ipu_apps.residual_add.residual_add_256x144 import ResidualAdd256x144App
"""
...
SPEC = KernelSpec(
    ...
    op="residual_add",
    variant="256x144",
    app_class=ResidualAdd256x144App,
    asm="residual_add_256x144.asm",
    requires=("shape",),
    tags=("fp32-wide",),
    supports=_supports,
    build=_build,
