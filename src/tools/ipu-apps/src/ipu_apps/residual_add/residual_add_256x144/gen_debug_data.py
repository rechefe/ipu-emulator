...
``test/test_residual_add_256x144_wide.py`` so that ``python -m ipu_apps.residual_add.residual_add_256x144`` exercises the
...
from ipu_apps.residual_add.residual_add_256x144 import N_ROWS, LANES
