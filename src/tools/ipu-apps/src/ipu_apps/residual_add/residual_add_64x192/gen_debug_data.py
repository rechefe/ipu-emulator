...
``python -m ipu_apps.residual_add.residual_add_64x192`` exercises the kernel the way its
test does.
...
from ipu_apps.residual_add.residual_add_64x192 import N_ROWS, N_TOK, LANES
