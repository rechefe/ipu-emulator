"""Debug runner for residual_add_16x240.
...
``test/test_residual_add_16x240_wide.py`` is the reference for correctness.

Usage::

    RESIDUAL_ADD_16X240_INST_BIN=/tmp/residual_add_16x240.bin \
    uv run python -m ipu_apps.residual_add_16x240
"""
...
from ipu_apps.residual_add_16x240.gen_debug_data import generate
