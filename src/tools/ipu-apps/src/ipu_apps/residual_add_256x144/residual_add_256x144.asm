...
row_loop:
    ...
    LDR_CYCLIC_MULT_REG lr2 cr0 lr0; ADD lr2 lr2 lr7; MULT.RC.VE lr0 cr10 0 lr0 cr15; ACC.ADD.FIRST;;
    # Cycle 2: r_acc += B[r] × 1.0
    LDR_CYCLIC_MULT_REG lr3 cr9 lr0; ADD lr3 lr3 lr7; MULT.RC.VE lr0 cr10 0 lr0 cr15; ACC.ADD;;
