"""Debug runner for concat_16x16x128x128.
...
Usage::
    ...
    CONCAT_16X16X128X128_INST_BIN=/tmp/concat_16x16x128x128.bin \
    uv run python -m ipu_apps.unfold.concat_16x16x128x128
"""
...
from ipu_apps.unfold.concat_16x16x128x128.gen_debug_data import generate


def main() -> None:
    _INST_BIN = Path(os.environ["CONCAT_16X16X128X128_INST_BIN"])

    work = Path(tempfile.mkdtemp(prefix="concat_16x16x128x128_"))
