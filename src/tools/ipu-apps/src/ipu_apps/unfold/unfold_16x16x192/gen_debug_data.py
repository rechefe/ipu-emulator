...
``test/test_unfold_16x16x192_wide.py`` so that ``python -m ipu_apps.unfold.unfold_16x16x192`` exercises the
...
from ipu_apps.unfold.unfold_16x16x192 import H, W, C, N_STRIPES, LANES
