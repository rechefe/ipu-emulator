...
Usage::
    ...
    from ipu_apps.unfold.unfold_32x32x144 import Unfold32x32x144App
"""
...
class Unfold32x32x144App(IpuApp):
    ...
    def setup(self, state: "IpuState") -> None:
        ...
        # anything else now raises EmulatorError (issue #230 / PR #231), even
...
SPEC = KernelSpec(
    name="unfold_32x32x144",
    op="unfold",
    variant="32x32x144",
    app_class=Unfold32x32x144App,
    asm="unfold_32x32x144.asm",
    requires=("shape",),
    tags=("fp32-wide",),
    supports=_supports,
    build=_build,
