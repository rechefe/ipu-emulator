...
``test/test_unfold_32x32x144_wide.py`` so that ``python -m ipu_apps.unfold_32x32x144`` exercises the
...
from ipu_apps.unfold_32x32x144 import H, W, C, N_STRIPES, LANES
