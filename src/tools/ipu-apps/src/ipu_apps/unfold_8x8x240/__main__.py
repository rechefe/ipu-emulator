...
Usage::
    ...
    uv run python -m ipu_apps.unfold_8x8x240
"""
...
from ipu_apps.unfold_8x8x240 import Unfold8x8x240App
from ipu_apps.unfold_8x8x240.gen_debug_data import generate
