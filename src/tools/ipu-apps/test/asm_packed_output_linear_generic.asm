...
# Status:  validated
# Related: asm_packed_output_linear_tiny.asm (K=8 validation origin);
#          asm_packed_output_linear_1slot.asm (1-slot optimization);
#          asm_packed_output_linear_silu.asm (SiLU variant);
#          asm_packed_output_linear_generic_p4.asm (L4 port)
# Tests:   test_packed_output_linear_generic.py
#
...
# full-L5-layer test. See docs/isa_friction_log.md's "Cross-kernel R_MASK
# state bleed" entry.
