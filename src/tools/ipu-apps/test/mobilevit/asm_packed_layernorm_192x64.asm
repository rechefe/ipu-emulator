...
#
# L4 variant of asm_packed_layernorm_240x16.asm: same six-step algorithm shape,
# only the partition count/width change (8x16 -> 2x64, per
# partition_size(64)=64 -> parts_per_chunk=128/64=2). The broadcast formula
# generalizes to rc_idx=(-64*p) mod 512 (NOT mod 128 -- same L5-derived
# correction, still applies here since the underlying MULT.RC.* cyclic ring
# is 512 elements regardless of partition width).
#
