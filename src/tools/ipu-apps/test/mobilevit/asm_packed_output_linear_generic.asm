...
# (30 packed chunks) and beyond.
#
# Layer:   L5
# Scope:   single-stream
# Layout:  packed (input, output) -- scatter-on-write construction
# Shape:   Kch->8ch x 16tok, packing factor 8 (K parameterized)
# Related: asm_packed_output_linear_silu.asm (SiLU variant);
#          asm_packed_output_linear_generic_p4.asm (P4 variant)
# Tests:   exercised via test_full_layer_l5_packed.py
#
# N_OUT is fixed at 8 per call: with N_OUT=8 the
...
# encountered directly when chaining this kernel into residual add for the
# full-L5-layer test.
