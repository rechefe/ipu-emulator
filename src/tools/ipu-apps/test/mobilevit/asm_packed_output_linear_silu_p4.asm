...
# FFN1 kernel (proj_ffn1_192_p4.asm). GELU is not used by any kernel in this
# codebase, so this kernel uses silu to match production.
#
# Packed-OUTPUT linear layer, L4 shape (K, N_OUT=2 fixed per call).
#
# L4 variant of asm_packed_output_linear_generic.asm: partition_size(64)=64 ->
# parts_per_chunk=128/64=2, so
...
# partition 1 unless the caller explicitly reloads R_MASK first. The
# same hazard applies at L4's 2-slot width as at L5.
