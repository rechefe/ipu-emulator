...
# this is the easy case for packed layout; contrast with the packed LINEAR
# kernel (C), which does need the cross-partition combine (primitive A)
# because contraction mixes packed input channels together.
#
