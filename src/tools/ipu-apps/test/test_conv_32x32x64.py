"""End-to-end regression tests for the 32x32 64->64 channel convolution app.
...
_CONV64_INST_BIN = Path(os.environ["CONV32X32X64_INST_BIN"])
_CONV64_DATA_DIR = Path(os.environ["CONV32X32X64_DATA_DIR"])


def _run_conv64(tmp_path: Path, dtype_dir: str, dtype_str: str) -> tuple[bytes, int]:
    """Run 32x32 64->64 conv app for a given dtype, return (output_bytes, cycles)."""
...
def test_conv_32x32x64(tmp_path: Path, dtype_dir: str, dtype_str: str, golden_name: str) -> None:
