"""End-to-end regression tests for the standard 8->16 channel conv app (64x64)."""
...
_INST_BIN = Path(os.environ["CONV64_8TO16_INST_BIN"])
_DATA_DIR = Path(os.environ["CONV64_8TO16_DATA_DIR"])
...
def test_conv_64x64_8to16(tmp_path: Path, dtype_dir: str, dtype_str: str, golden_name: str) -> None:
