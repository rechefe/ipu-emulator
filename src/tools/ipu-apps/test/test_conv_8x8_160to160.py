"""End-to-end regression tests for the standard 160->160 channel conv app (8x8)."""
...
from ipu_apps.conv_8x8_160to160 import Conv8x8_160to160App


_INST_BIN = Path(os.environ["CONV8X8_160TO160_INST_BIN"])
_DATA_DIR = Path(os.environ["CONV8X8_160TO160_DATA_DIR"])
...
def _run(tmp_path: Path, dtype_dir: str, dtype_str: str) -> tuple[bytes, int]:
    ...
    _, cycles = app.run(max_cycles=500_000_000)
...
def test_conv_8x8_160to160(tmp_path: Path, dtype_dir: str, dtype_str: str, golden_name: str) -> None:
