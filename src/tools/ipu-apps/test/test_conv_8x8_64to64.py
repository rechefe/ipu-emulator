"""End-to-end regression tests for the standard 64->64 channel conv app (8x8)."""
...
from ipu_apps.conv_8x8_64to64 import Conv8x8_64to64App


_INST_BIN = Path(os.environ["CONV8X8_64TO64_INST_BIN"])
_DATA_DIR = Path(os.environ["CONV8X8_64TO64_DATA_DIR"])
...
def test_conv_8x8_64to64(tmp_path: Path, dtype_dir: str, dtype_str: str, golden_name: str) -> None:
