"""End-to-end regression tests for the 64-channel depthwise convolution app.
...
def _run_dconv64(tmp_path: Path, dtype_dir: str, dtype_str: str) -> tuple[bytes, int]:
    """Run 64-ch depthwise conv app for a given dtype, return (output_bytes, cycles)."""
...
def test_depthwise_conv_128x128x64(tmp_path: Path, dtype_dir: str, dtype_str: str, golden_name: str) -> None:
    actual, cycles = _run_dconv64(tmp_path, dtype_dir, dtype_str)
    assert cycles > 0
