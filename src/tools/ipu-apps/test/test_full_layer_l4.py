...
from ipu_apps.projections.proj_qkv_192_p4 import ProjQkv192P4App, K as QKV_K, N_OUT as QKV_N_OUT
...
import ipu_apps.attention.attn_v_bcast_48 as attn_v_bcast_48_mod
from ipu_apps.projections.proj_outproj_192_p4 import ProjOutProj192P4App, K as OUTPROJ_K, N_OUT as OUTPROJ_N_OUT
from ipu_apps.residual_add.residual_add_64x192 import ResidualAdd64x192App
from ipu_apps.projections.proj_ffn1_192_p4 import ProjFFN1192P4App, K as FFN1_K, N_OUT as FFN1_N_OUT
from ipu_apps.projections.proj_ffn2_192_p4 import ProjFFN2192P4App, K as FFN2_K, N_OUT as FFN2_N_OUT
...
_LN_INST = app_inst("layernorm", "layernorm_64x192")
_QKV_INST = app_inst("projections", "proj_qkv_192_p4")
_QK_INST = app_inst("attention", "qk_scores_64x48")
_KM_INST = app_inst("attention", "attn_scores_km_64x48")
_AV_INST = app_inst("attention", "attn_v_64x48")
_AVBC_INST = app_inst("attention", "attn_v_bcast_48")
_OUTPROJ_INST = app_inst("projections", "proj_outproj_192_p4")
_RESID_INST = app_inst("residual_add", "residual_add_64x192")
_FFN1_INST = app_inst("projections", "proj_ffn1_192_p4")
_FFN2_INST = app_inst("projections", "proj_ffn2_192_p4")
