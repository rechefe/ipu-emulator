...
from ipu_apps.projections.proj_qkv_240_p4 import ProjQKV240P4App, K as QKV_K, N_OUT as QKV_N_OUT
...
from ipu_apps.attention.attn_v_16x60 import AttnV16x60App
from ipu_apps.attention.attn_v_bcast_60 import AttnVBcast60App
import ipu_apps.attention.attn_v_bcast_60 as attn_v_bcast_60_mod
from ipu_apps.projections.proj_outproj_240_p4 import ProjOutProj240P4App, K as OUTPROJ_K, N_OUT as OUTPROJ_N_OUT
from ipu_apps.residual_add.residual_add_16x240 import ResidualAdd16x240App
from ipu_apps.projections.proj_ffn1_240_p4 import ProjFFN1240P4App, K as FFN1_K, N_OUT as FFN1_N_OUT
from ipu_apps.projections.proj_ffn2_240_p4 import ProjFFN2240P4App, K as FFN2_K, N_OUT as FFN2_N_OUT
...
# Assembled in-process (app_inst caches per name) rather than read from a
# Bazel-genrule .bin path via env var -- see fixture_full_layer_chain.py.
_LN_INST = app_inst("layernorm", "layernorm_16x240")
_QKV_INST = app_inst("projections", "proj_qkv_240_p4")
_QK_INST = app_inst("attention", "qk_scores_16x60")
_KM_INST = app_inst("attention", "attn_scores_km_16x60")
_AV_INST = app_inst("attention", "attn_v_16x60")
_AVBC_INST = app_inst("attention", "attn_v_bcast_60")
_OUTPROJ_INST = app_inst("projections", "proj_outproj_240_p4")
_RESID_INST = app_inst("residual_add", "residual_add_16x240")
_FFN1_INST = app_inst("projections", "proj_ffn1_240_p4")
_FFN2_INST = app_inst("projections", "proj_ffn2_240_p4")
