...
import ipu_apps.attention.qk_scores_16x60 as qk_mod
from ipu_apps.attention.attn_v_16x60 import AttnV16x60App
import ipu_apps.attention.attn_v_16x60 as attnv_mod
...
def run_qk_scores_one_head(main_state: IpuState, *, q_unpacked_base_row: int,
    ...
    row-0 data)."""
    import ipu_apps.attention.qk_scores_16x60 as qk
...
def run_attn_v_all_heads(main_state: IpuState, *, probs_by_head: list[np.ndarray],
    ...
    import ipu_apps.attention.attn_v_16x60 as av
