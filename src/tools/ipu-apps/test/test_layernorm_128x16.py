...
from ipu_apps.layernorm.layernorm_128x16.gen_test_data import reference_layernorm
...
def inst_file():
    with tempfile.TemporaryDirectory() as tmp:
        path = Path(tmp) / "layernorm_128x16.bin"
...
def test_layernorm_128x16_wide_fp32(inst_file: Path, tmp_path: Path) -> None:
