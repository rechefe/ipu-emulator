...
from ipu_apps.matmuls.matmul_128x64x128 import MatMul128x64x128App, M, K, N
...
def inst_file():
    with tempfile.TemporaryDirectory() as tmp:
        path = Path(tmp) / "matmul_128x64x128.bin"
...
def test_matmul_128x64x128_wide_fp32(inst_file: Path, tmp_path: Path) -> None:
