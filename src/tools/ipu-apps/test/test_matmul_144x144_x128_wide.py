...
def inst_file():
    with tempfile.TemporaryDirectory() as tmp:
        path = Path(tmp) / "matmul_144x144_x128.bin"
...
def test_matmul_144x144_x128_wide_fp32(inst_file: Path, tmp_path: Path) -> None:
