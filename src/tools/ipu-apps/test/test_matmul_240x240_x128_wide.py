...
from ipu_apps.matmuls.matmul_240x240_x128 import MatMul240x240x128App, K, N_OUT, N_TOK, LANES
...
def inst_file():
    with tempfile.TemporaryDirectory() as tmp:
        path = Path(tmp) / "matmul_240x240_x128.bin"
...
def test_matmul_240x240_x128_wide_fp32(inst_file: Path, tmp_path: Path) -> None:
