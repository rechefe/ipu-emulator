...
from ipu_apps.matmuls.matmul_240x480_x128 import (
...
def inst_file():
    with tempfile.TemporaryDirectory() as tmp:
        path = Path(tmp) / "matmul_240x480_x128.bin"
...
def test_matmul_240x480_x128_wide_fp32(inst_file: Path, tmp_path: Path) -> None:
