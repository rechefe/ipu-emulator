...
from ipu_apps.matmul_64x64x64 import MatMul64x64x64App, M, K, N

_INST_BIN = Path(os.environ["MATMUL_64X64X64_INST_BIN"])
...
def test_matmul_64x64x64_wide_fp32(tmp_path: Path) -> None:
