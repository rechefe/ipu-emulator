...
from ipu_apps.matmuls.matmul_720x240_x128 import MatMul720x240x128App, K, N_OUT, N_TOK, LANES
...
def inst_file():
    with tempfile.TemporaryDirectory() as tmp:
        path = Path(tmp) / "matmul_720x240_x128.bin"
...
def test_matmul_720x240_x128_wide_fp32(inst_file: Path, tmp_path: Path) -> None:
