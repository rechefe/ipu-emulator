"""End-to-end regression tests for the 128x128x16→64 pointwise convolution application.
...
_PCONV128_INST_BIN = Path(os.environ["PCONV128_16TO64_INST_BIN"])
_PCONV128_DATA_DIR = Path(os.environ["PCONV128_16TO64_DATA_DIR"])


def _run_pointwise_conv(tmp_path: Path, dtype_dir: str, dtype_str: str) -> tuple[bytes, int]:
    """Run 128x128x16→64 pointwise conv app for a given dtype, return (output_bytes, cycles)."""
...
def test_pointwise_conv_128x128_16to64(tmp_path: Path, dtype_dir: str, dtype_str: str, golden_name: str) -> None:
