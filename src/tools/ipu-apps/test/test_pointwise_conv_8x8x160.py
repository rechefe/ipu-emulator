"""End-to-end regression tests for the pointwise 160ch conv app (8x8)."""
...
_INST_BIN = Path(os.environ["POINTWISE_CONV_8X8X160_INST_BIN"])
_DATA_DIR = Path(os.environ["POINTWISE_CONV_8X8X160_DATA_DIR"])
...
def test_pointwise_conv_8x8x160(tmp_path: Path, dtype_dir: str, dtype_str: str, golden_name: str) -> None:
