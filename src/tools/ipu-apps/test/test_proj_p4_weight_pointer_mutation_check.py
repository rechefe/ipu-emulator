...
from ipu_apps.proj_qkv_192_p4 import ProjQkv192P4App, K as QKV192_K, N_OUT as QKV192_N_OUT, N_TOK as QKV192_N_TOK, N_STREAM as QKV192_P, LANES as QKV192_LANES
from ipu_apps.proj_qkv_240_p4 import ProjQKV240P4App, K as QKV240_K, N_OUT as QKV240_N_OUT, N_TOK as QKV240_N_TOK, N_STREAM as QKV240_P, LANES as QKV240_LANES
from ipu_apps.proj_outproj_192_p4 import ProjOutProj192P4App, K as OP192_K, N_OUT as OP192_N_OUT, N_TOK as OP192_N_TOK, N_STREAM as OP192_P, LANES as OP192_LANES
from ipu_apps.proj_outproj_240_p4 import ProjOutProj240P4App, K as OP240_K, N_OUT as OP240_N_OUT, N_TOK as OP240_N_TOK, N_STREAM as OP240_P, LANES as OP240_LANES
from ipu_apps.proj_ffn1_192_p4 import ProjFFN1192P4App, K as F1_192_K, N_OUT as F1_192_N_OUT, N_TOK as F1_192_N_TOK, N_STREAM as F1_192_P, LANES as F1_192_LANES
from ipu_apps.proj_ffn1_240_p4 import ProjFFN1240P4App, K as F1_240_K, N_OUT as F1_240_N_OUT, N_TOK as F1_240_N_TOK, N_STREAM as F1_240_P, LANES as F1_240_LANES
from ipu_apps.proj_ffn2_192_p4 import ProjFFN2192P4App, K as F2_192_K, N_OUT as F2_192_N_OUT, N_TOK as F2_192_N_TOK, N_STREAM as F2_192_P, LANES as F2_192_LANES
from ipu_apps.proj_ffn2_240_p4 import ProjFFN2240P4App, K as F2_240_K, N_OUT as F2_240_N_OUT, N_TOK as F2_240_N_TOK, N_STREAM as F2_240_P, LANES as F2_240_LANES

from ipu_emu.ipu_state import IpuState, WideVectorArithmetic

_KERNELS = [
    pytest.param(ProjQkv192P4App, "PROJ_QKV_192_P4_INST_BIN", QKV192_K, QKV192_N_OUT, QKV192_N_TOK, QKV192_P, QKV192_LANES, False, id="proj_qkv_192_p4"),
    pytest.param(ProjQKV240P4App, "PROJ_QKV_240_P4_INST_BIN", QKV240_K, QKV240_N_OUT, QKV240_N_TOK, QKV240_P, QKV240_LANES, False, id="proj_qkv_240_p4"),
    pytest.param(ProjOutProj192P4App, "PROJ_OUTPROJ_192_P4_INST_BIN", OP192_K, OP192_N_OUT, OP192_N_TOK, OP192_P, OP192_LANES, False, id="proj_outproj_192_p4"),
    pytest.param(ProjOutProj240P4App, "PROJ_OUTPROJ_240_P4_INST_BIN", OP240_K, OP240_N_OUT, OP240_N_TOK, OP240_P, OP240_LANES, False, id="proj_outproj_240_p4"),
    ...
    pytest.param(ProjFFN1192P4App, "PROJ_FFN1_192_P4_INST_BIN", F1_192_K, F1_192_N_OUT, F1_192_N_TOK, F1_192_P, F1_192_LANES, True, id="proj_ffn1_192_p4"),
    pytest.param(ProjFFN1240P4App, "PROJ_FFN1_240_P4_INST_BIN", F1_240_K, F1_240_N_OUT, F1_240_N_TOK, F1_240_P, F1_240_LANES, True, id="proj_ffn1_240_p4"),
    pytest.param(ProjFFN2192P4App, "PROJ_FFN2_192_P4_INST_BIN", F2_192_K, F2_192_N_OUT, F2_192_N_TOK, F2_192_P, F2_192_LANES, False, id="proj_ffn2_192_p4"),
    pytest.param(ProjFFN2240P4App, "PROJ_FFN2_240_P4_INST_BIN", F2_240_K, F2_240_N_OUT, F2_240_N_TOK, F2_240_P, F2_240_LANES, False, id="proj_ffn2_240_p4"),
]
...
@pytest.mark.parametrize("App,envvar,K,N_OUT,N_TOK,N_STREAM,LANES,applies_silu", _KERNELS)
def test_proj_p4_weight_row_is_not_stuck_at_channel_zero(
    App, envvar, K, N_OUT, N_TOK, N_STREAM, LANES, applies_silu, tmp_path: Path,
) -> None:
    ...
    """
    inst_bin = Path(os.environ[envvar])
