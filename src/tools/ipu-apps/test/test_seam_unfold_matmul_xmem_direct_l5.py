...
from ipu_apps.matmul_720x240_x128 import (
...
_UF_INST_BIN = Path(os.environ["UNFOLD_8X8X240_INST_BIN"])
...
def _run_matmul_720x240_direct_xmem_handoff(
    ...
    from ipu_apps.matmul_720x240_x128 import _load_weights as mm_load_weights
