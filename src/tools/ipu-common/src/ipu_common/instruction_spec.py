        ...
        "MULT.EE": {
            ...
            "doc": InstructionDoc(
                ...
                operands=[
                    ...
                    "`mask_shift`: **`LR0`**…**`LR15`** — index ∈ [−3, +3] selecting one of seven masks generated by sequential shift-and-AND with the partition vector.",
                ],
        ...
        "MULT.VE.CR": {
            ...
            "doc": InstructionDoc(
                ...
                operands=[
                    ...
                    "mask_shift: index ∈ [−3, +3] selecting one of seven masks via sequential shift-and-AND with the partition vector",
