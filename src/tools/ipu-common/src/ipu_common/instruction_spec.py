    ...
    "mult": {
        ...
        "mult.ve": {
            ...
            "doc": InstructionDoc(
                ...
                summary="Multiply a fixed element from Ra against RC[cyclic_offset:cyclic_offset+128]. Elements beyond RC boundary are treated as 1 (dtype-specific).",
                ...
                operation="For i in [0,128): rb = RC[cyclic_offset+i] if in bounds else dtype_one; mult_res[i] = Ra[fixed_ra_idx] * rb",
